...
POLY=${NC-MAKE}/mkgmap-resources/barriers.poly
#POLY=${NC-MAKE}/mkgmap-resources/great-britain.poly
...
echo "copying .exe files folder to destination" $(date -u)
scp -r -P 22 ${ZIPPED}/${NME}-winexe-${DATE}* ${DESTINATION}
# 
...
scp -r -P 22 ${ZIPPED}/${NME}-gmapi-${DATE}.* ${DESTINATION}
#
...
#
scp -P 22 ${ZIPPED}/${NME}-${DATE}.* ${DESTINATION}
#
