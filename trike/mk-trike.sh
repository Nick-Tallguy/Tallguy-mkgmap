...
rm -r ${GMAKE}/work/*
java -Xms1024m -Xmx14g  -jar ${GHUB}/mkgmap-progs/mkgmap-r4923/mkgmap.jar -c ${NC_STYLES}/${NME}.args -c ${GMAKE}/splitter/template.args --description="Garmin_compatible_trike_map" ${NC_STYLES}/5409.txt --gmapsupp --gmapi --nsis
PROCESS_RETURN
##
