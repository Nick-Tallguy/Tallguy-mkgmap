...
#
## OSMCONVERT  
#osmconvert ${PBF}/barriers.osm.pbf --out-o5m >${PBF}/barriers.o5m
## OSMFILTER
osmfilter ${PBF}/barriers.o5m --parameter-file=${TYPS}/trike/my_parameters  -o=${PBF}/barriers-1.o5m
#osmfilter ${PBF}/barriers.o5m --out-key=highway
cd ${GMAKE}/work
#
## SPLITTER
rm -r ${GMAKE}/splitter/*
echo "starting splitter" $(date -u)
java -Xmx7g -jar ${NC_GMAKE}/mkgmap-progs/splitter-r653/splitter.jar --output=pbf --output-dir=${GMAKE}/splitter --max-nodes=1400000 --mapid=10010001 --geonames-file=${NC_GMAKE}/mkgmap-resources/cities15000.zip   --polygon-file=${POLY} ${PBF}/barriers-1.o5m
#
### MKGMAP 
